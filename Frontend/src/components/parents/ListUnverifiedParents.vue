        ...
        <div class="flex p-4" v-if="unverifiedParents != null">
            <div class="justify-center w-full">
                ...
                <div class="w-full overflow-y-auto max-h-60">
                    ...
                    <div v-for="parent in unverifiedParents" :key="parent.id" class="w-full mb-4">
                        <div
...
function removeParent(parentId) {
    // Poner un mensaje de que si acepto la solicitud o rechazo
    unverifiedParents.value = unverifiedParents.value.filter(parent => parent.id !== parentId);
}
</script>