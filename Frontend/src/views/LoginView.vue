<template lang="html">
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-lg">
      <h1 class="text-center text-2xl font-bold text-main-green sm:text-3xl">Iniciar sesión</h1>
      <form @submit.prevent="submitForm" class="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
        <p class="mx-auto mt-4 max-w-md text-center text-gray-500">
          Bienvenido de nuevo a Train Track, introduzca sus datos para acceder a las funciones de su hijo/s
        </p>
        ...
        <p class="text-center text-sm text-gray-500">
          ...
          <router-link class="underline" to="/signup">Pulse aquí para registrarse</router-link>
        </p>
      </form>
    </div>
  </div>
