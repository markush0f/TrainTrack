<template>
  <div>
    ...
    <div class="flex flex-col md:flex-row mt-16 h-full">
      <!-- Texto de bienvenida -->
      <div
        class="flex flex-col items-center justify-center md:w-1/2 p-6 text-center"
      >
        <img src="../img/LogoTrainTrack.png" alt="" class="flex w-80" />
        <p class="text-2xl font-semibold mb-4">¡Bienvenido a TRANTRACK!</p>
        <p class="text-gray-700">
          En TrainTrack, estamos emocionados de ofrecerte una herramienta que
          facilita la comunicación entre jugadores y entrenadores, ademas de
          muchas mas funciones que mantendrán al tanto a los padres sobre los
          jugadores. Sabemos lo importante que es mantener una conexión efectiva
      ...
      <div class="flex flex-col md:w-1/2 justify-center p-4">
        <div class="w-full justify-center p-4 pr-10">
          <div class="justify-center p-4 flex">
            <div class="ml-4">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/b/b5/Logotipo_del_Gobierno_de_Canarias.svg"
                alt="Federacion"
                class="w-56"
              />
            </div>
          ...
          <div class="justify-center p-4">
            <router-link to="/parent" class="max-w-xl w-full">
              <div
                class="bg-gray-100 p-8 rounded-lg shadow-lg hover:shadow-xl transition duration-300"
              >
                <h2 class="text-2xl font-semibold mb-4">Entrar como padre</h2>
                <p class="text-gray-700">
                  Si no tienes cuenta, primero registra el equipo al que
                  pertenece tu hijo.
                </p>
              </div>
            </router-link>
